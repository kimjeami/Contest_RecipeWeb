...
<body>
      <div class="container">
           ...
           <form action="/recipe/write" method="post" enctype="multipart/form-data" id="boardWriteForm" name="boardWriteForm">
                     <input type="hidden" id="write_name" name="write_name" value="${loginMemberVo.nick}">
